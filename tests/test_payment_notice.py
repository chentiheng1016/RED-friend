...
_POSITIVES = [
    ...
    ("sms-adm@mail.bank.example",
     ...
     "fcb_domestic_inward"),
    ('"國泰世華銀行" <service@mail.bank2.example>',
    ...
    ("tms-customer-d@finance-portal.example",
     ...
     "decathlon_notice_of_transfer"),
    # 客戶明講已付款的斷言句型。
    ('"contact.one" <contact.one@supplier-c.example>',
...
_NEGATIVES = [
    ...
    ('"contact.one" <contact.one@supplier-c.example>', "RE: pending payment det"),
    # 我方向客戶申請付款 / 談付款排程。
    ("ContactC Le <contact.one@customer-c.example>",
    ...
    ("sales@vn.supplier-e.example", "FUCHUN's PAYMENT ON MAY-2026.xls"),
    ...
    # 主旨帶 advice 但跟付款無關。
    ("sales2005 <sales@supplier-d.example>",
     "pre-order advice  J0M25120108  PU467 (required date early of March 2026)"),
    ('"Contact Person" <contact.one@customer-e.example>', "DISPATCH ADVICE JA251209-03 09.12.2025"),
